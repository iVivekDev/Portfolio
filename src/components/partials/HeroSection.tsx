...
import { FaLinkedin } from 'react-icons/fa'; // Changed double quotes to single quotes
  ...
  return (
    <div className="hero relative -mt-16 flex items-center justify-center">
      ...
      <div className="flex flex-col items-center">
        ...
        <h1 className="mt-4 text-3xl font-bold ">Paritoshek JK Gupta </h1>
        ...
        <div className="mt-4  flex gap-5">
          <Link href="https://www.linkedin.com/in/paritoshek-jk-gupta-630453149?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
